...
# --- DONNÉES DÉTAILLÉES (Extrait de CamScanner 30-06-2026 18.29_2.pdf) ---
data = {
    ...
    "elec": [
        ...
        {"tranche": "Tranche 2", "qte": 125.0, "prix": 4.1789, "mt": 744.70}, # Valeurs indicatives basées sur[cite: 2]
        {"tranche": "Tranche 3", "qte": 312.0, "prix": 4.8120, "mt": 1501.34}
    ],
    # Gaz[cite: 2]
    "gaz": [
        {"tranche": "Tranche 1", "qte": 1125.0, "prix": 0.1682, "mt": 635.42},
        {"tranche": "Tranche 2", "qte": 1375.0, "prix": 0.3245, "mt": 635.42}, # Valeurs indicatives basées sur[cite: 2]
...
<div style="border: 2px solid #2980b9; padding: 20px; font-family: Arial, sans-serif;">
    ...
    <table style="width:100%; border-collapse: collapse;">
        <tr style="background-color: #d6eaf8;"><th>Tranche</th><th>Quantité (kWh)</th><th>Prix Unitaire (DA)</th><th>Montant HT (DA)</th></tr>
        {"".join([f"<tr><td>{i['tranche']}</td><td>{i['qte']}</td><td>{i['prix']}</td><td>{i['mt']}</td></tr>" for i in data['elec']])}
    </table>

    <h3 style="color: #2980b9;">Gaz</h3>
    <table style="width:100%; border-collapse: collapse;">
        <tr style="background-color: #d6eaf8;"><th>Tranche</th><th>Quantité (Th)</th><th>Prix Unitaire (DA)</th><th>Montant HT (DA)</th></tr>
    ...
    <div style="margin-top: 20px; border-top: 2px solid #2980b9; padding-top: 10px;">
        <p>Redevance fixe : {data['redevance']} DA</p>
        <p>TVA (9% : {data['tva_9']} DA | 19% : {data['tva_19']} DA)</p>
